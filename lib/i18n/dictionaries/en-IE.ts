...
export const enIE = {
  ...
  result: {
    ...
    premiumModal: {
      ...
      appleLoading: "Signing you in with Apple...",
      appleError: "Could not continue with Apple. Please try again or use email.",
      divider: "or",
  ...
  common: {
    ...
    updateDataFlow: {
      reanalyseTitle: "Reanalyse existing data",
      reanalyseBody: "Use your current Engage7 dataset to generate a fresh analysis.",
      reanalyseAction: "Reanalyse",
      uploadTitle: "Upload new Apple Health export",
      uploadBody: "Add a newer Apple Health export to update your timeline.",
      uploadAction: "Upload export",
      confirm: "Engage7 will reuse your existing data. No Apple Health ZIP is required, previous analyses remain available, and processing may take some time.",
      noData: "No existing data is available. Upload a new Apple Health export instead.",
      completed: "Your fresh analysis is ready.",
  ...
  auth: {
    login: {
      ...
      otpSent: "If the account is eligible, a six-digit code has been sent.",
      otpError: "The code could not be verified. Request a new code and try again.",
      usePassword: "Use password instead",
      useEmailCode: "Use an email code instead",
      adminDenied: "This account is not authorised for the Admin Portal.",
      password: "Password",
    ...
    callback: {
      ...
      generic: "Could not complete sign-in. Please try again or use another method.",
      identityMismatch:
        "This sign-in method is already connected to another Engage7 account.",
  ...
  portal: {
    ...
    signInMethods: {
      ...
      legacyPassword: "Legacy password sign-in remains available during the Email transition.",
      appleError: "Apple could not be connected. This method may already belong to another Engage7 account.",
    ...
    dataLab: {
      ...
      periodLabel: "Evidence window",
      period30Days: "30 days",
      period90Days: "90 days",
      periodAll: "All data",
      evidenceWindow: "Evidence window",
      evidenceWindowDescription:
        "Transparent provenance and data quality for the selected longitudinal window.",
      analyses: "Analyses",
      ...
      descriptiveStatisticsDescription:
        "Sample statistics calculated only from observed values; missing data is never converted to zero.",
      signal: "Signal",
      missing: "Missing",
      coverage: "Observed-day coverage",
      mean: "Mean",
      median: "Median",
      standardDeviation: "Sample SD",
