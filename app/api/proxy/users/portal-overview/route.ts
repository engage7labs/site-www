/**
 * Server-side proxy: GET /api/proxy/users/portal-overview
 *
 * Fetches portal overview data for the authenticated user.
...
export async function GET() {
  ...
  const path = `/api/users/me/portal-overview?email=${encodeURIComponent(
    email
  )}`;
