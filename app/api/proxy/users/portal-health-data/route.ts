/**
 * Server-side proxy: GET /api/proxy/users/portal-health-data
 *
 * Fetches the authenticated user's persisted feature-store health timeline.
 */
...
export async function GET() {
  ...
  const path = `/api/users/me/portal-health-data?email=${encodeURIComponent(
    email
  )}`;
