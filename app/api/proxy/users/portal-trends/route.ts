/**
 * Server-side proxy: GET /api/proxy/users/portal-trends
 *
 * Fetches portal trend data for the authenticated user.
...
export async function GET() {
  ...
  const path = `/api/users/me/portal-trends?email=${encodeURIComponent(email)}`;
