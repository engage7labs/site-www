 ...
 *
 * Reusable social sharing buttons for WhatsApp, Facebook, LinkedIn, X, and Copy Link.
 */
...
export function SocialShare({ url, text, t, className }: SocialShareProps) {
  ...
  return (
    <div className={cn("grid grid-cols-2 sm:grid-cols-3 gap-3", className)}>
      ...
      >
        ...
        <span className="ml-2">{copied ? t.copied : t.copyLink}</span>
      </Button>
    </div>
  );
}
